...
class RecipeCard extends HTMLElement {
	...
	constructor() {
		...
		let articleE1 = document.createElement('article');
		let styleE1 = document.createElement('style');
		...
		shadowE1.appendChild(styleE1);
		shadowE1.appendChild(articleE1);
	...
	set data(data) {
	  ...
	  <div class="rating">
		...
		<img src="/assets/images/icons/${data.rating}-star.svg" alt="Rating">
